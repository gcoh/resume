...
<section class="section" id="summary">
    ...
    <p>מומחה בכיר במערכות פיננסיות, בעל יכולת לגשר בין צוותים עסקיים וטכניים. מתמחה בפלטפורמות מסחר, CI/CD וארכיטקטורות נתונים, הוביל מספר הגירות מורכבות והטמיע אוטומציות המפחיתות משמעותית עלויות תפעול.</p>
</section>

<section class="section" id="impact">
    <h2><i class="fa-solid fa-chart-line"></i> השפעה מרכזית</h2>
    <ul class="impact-list">
        <li><i class="fa-solid fa-circle"></i> הוביל בהצלחה הגירה רחבת היקף על פני מספר סביבות, תוך הבטחת רציפות עסקית והפגנת שליטה בתשתיות מורכבות בקנה מידה גדול</li>
