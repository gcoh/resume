...
layout: default
lang: he
title: "גבריאל כהן — מוביל טכנולוגי / ארכיטקט"
...
<section class="section" id="summary">
    ...
    <p>מומחה בכיר במערכות פיננסיות, אני מגשר בין צוותים עסקיים וטכניים. מתמחה בפלטפורמות מסחר, CI/CD וארכיטקטורות, הובלתי מספר מיגרציות מורכבות והטמעתי אוטומציות המפחיתות משמעותית עלויות תפעול.</p>
</section>

<section class="section" id="impact">
    <h2><i class="fa-solid fa-chart-line"></i> השפעה מרכזית</h2>
    <ul class="impact-list">
        <li><i class="fa-solid fa-circle"></i> <strong>הובלת</strong> מיגרציות רחבת היקף על פני מספר סביבות, תוך הבטחת רציפות עסקית ושליטה בתשתיות מורכבות</li>
        <li><i class="fa-solid fa-circle"></i> <strong>צמצום</strong> זמן בניות והפצות וביטול בדיקות שגיאות ידניות באמצעות אוטומציית CI/CD וניטורים</li>
        <li><i class="fa-solid fa-circle"></i> <strong>שיפור</strong> בצועים וניטור בעזרת כלים כמו Zabbix, ELK, Grafana, AppDynamics</li>
        <li><i class="fa-solid fa-circle"></i> <strong>אופטימיזציה</strong> של ארכוב Oracle עבור מערכות בנפח גבוה</li>
        <li><i class="fa-solid fa-circle"></i> <strong>גישור</strong> בין צוותי עסקים, דאטה ותשתיות להבטחת רציפות</li>
    </ul>
</section>
    ...
    <div class="exp-grid">
        <div class="exp-item">
            ...
            <ul>
                ...
                <li>תכנון והטמעת פיפלין CI/CD</li>
                <li>אוטומציה של בניה והפצות</li>
...
<section class="section" id="skills">
    ...
    <div class="print-only">
        <table class="print-table">
            <tr><th>קטגוריה</th><th>טכנולוגיות</th></tr>
            <tr><td>DevOps וכלים</td><td>Jenkins, Docker, Kubernetes, CI/CD, Harbor, ArgoCD, Rancher, Portainer, Gitea, MinIO, Headlamp, Traefik, AWS, Control-M, Git, GitHub Actions, n8n</td></tr>
            <tr><td>ניטור</td><td>Zabbix, ELK, Grafana, AppDynamics, Prometheus</td></tr>
            <tr><td>מערכות</td><td>Linux/Unix, Windows Server, VMware, Citrix</td></tr>
            <tr><td>בסיסי נתונים</td><td>Oracle, SQL Server, SSIS</td></tr>
            <tr><td>תכנות</td><td>Python, Java, C#, PowerShell, Bash</td></tr>
        </table>
    </div>
</section>
...
<div class="bottom-cols">
    <section class="section" id="ai">
        ...
        <p class="screen-only" style="font-size:0.82rem;">שילוב כלי AI (LLMs) בתהליכים תפעוליים, אוטומציה של תהליכים באמצעות <strong>n8n</strong> ו-APIs, פיתוח פתרונות אוטומציה של נתונים ודיווח. שימוש ב-<strong>Ollama, Hermes, PyTorch, FastAPI, MCP</strong>. ניהול <strong>K8s</strong>, בנייה וניטור עם <strong>Agent</strong>.</p>
        <div class="print-only">
            <table class="print-table">
                <tr><th>AI ואוטומציה</th></tr>
                <tr><td>LLMs, Ollama, Hermes, PyTorch, FastAPI, MCP, n8n, APIs — ניהול K8s, בנייה וניטור עם Agent</td></tr>
            </table>
        </div>
    </section>
...
<div class="bottom-cols">
    <section class="section" id="languages">
        ...
        <div class="print-only">
            <table class="print-table">
                <tr><th>שפה</th><th>רמה</th></tr>
                <tr><td>צרפתית</td><td>שפת אם</td></tr>
                <tr><td>עברית</td><td>שוטף</td></tr>
                <tr><td>אנגלית</td><td>מקצועית</td></tr>
            </table>
        </div>
    </section>
