...
<section class="section" id="impact">
    ...
    <ul class="impact-list">
        <li><i class="fa-solid fa-circle"></i> הובלתי בהצלחה הגירה רחבת היקף על פני מספר סביבות, תוך הבטחת רציפות עסקית והפגנת שליטה בתשתיות מורכבות בקנה מידה גדול</li>
