...
<div class="bottom-cols">
    <section class="section" id="ai">
        ...
        <p style="font-size:0.82rem;">שילוב כלי AI (LLMs) בתהליכים תפעוליים, אוטומציה של תהליכים באמצעות <strong>n8n</strong> ו-APIs, פיתוח פתרונות אוטומציה של נתונים ודיווח. שימוש ב-<strong>Ollama, Hermes, PyTorch, FastAPI, MCP</strong>. ניהול <strong>K8s</strong>, בנייה וניטור עם <strong>Agent</strong>.</p>
    </section>
...
<div class="bottom-cols">
    <section class="section" id="languages">
        ...
        <p style="font-size:0.75rem;color:var(--muted);margin-top:0.5rem;">
            <a href="#contact" style="color:var(--accent-brown);">צור קשר</a>
        </p>
    </section>
