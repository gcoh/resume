...
<section class="section" id="impact">
    ...
    <ul class="impact-list">
        <li><i class="fa-solid fa-circle"></i> הובלתי בהצלחה מיגרציות רחבת היקף על פני מספר סביבות, תוך הבטחת רציפות עסקית והפגנת שליטה בתשתיות מורכבות בקנה מידה גדול</li>
        <li><i class="fa-solid fa-circle"></i> צמצמתי את זמן הפריסה וביטלתי שגיאות ידניות באמצעות <strong>אוטומציית CI/CD</strong></li>
        <li><i class="fa-solid fa-circle"></i> שיפרתי את הנראות בייצור עם <strong>Zabbix, ELK, Grafana, AppDynamics</strong></li>
        <li><i class="fa-solid fa-circle"></i> ביצעתי אופטימיזציה של <strong>ארכוב Oracle</strong> עבור מערכות בנפח גבוה</li>
        <li><i class="fa-solid fa-circle"></i> גישרתי בין צוותי עסקים, דאטה ותשתיות להבטחת רציפות</li>
    </ul>
</section>
