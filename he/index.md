...
<section class="section" id="summary">
    ...
    <p>מומחה בכיר במערכות פיננסיות, אני מגשר בין צוותים עסקיים וטכניים. מתמחה בפלטפורמות מסחר, CI/CD וארכיטקטורות נתונים, הובלתי מספר הגירות מורכבות והטמעתי אוטומציות המפחיתות משמעותית עלויות תפעול.</p>
</section>
