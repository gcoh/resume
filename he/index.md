...
<section class="section" id="summary">
    ...
    <p>מומחה בכיר במערכות פיננסיות, אני מגשר בין צוותים עסקיים וטכניים. מתמחה בפלטפורמות מסחר, CI/CD וארכיטקטורות נתונים, הובלתי מספר מיגרציות מורכבות והטמעתי אוטומציות המפחיתות משמעותית עלויות תפעול.</p>
</section>

<section class="section" id="impact">
    <h2><i class="fa-solid fa-chart-line"></i> השפעה מרכזית</h2>
    <ul class="impact-list">
        <li><i class="fa-solid fa-circle"></i> <strong>הובלת</strong> מיגרציות רחבת היקף על פני מספר סביבות, תוך הבטחת רציפות עסקית והפגנת שליטה בתשתיות מורכבות בקנה מידה גדול</li>
        <li><i class="fa-solid fa-circle"></i> <strong>צמצום</strong> זמן הפריסה וביטול שגיאות ידניות באמצעות אוטומציית CI/CD</li>
        <li><i class="fa-solid fa-circle"></i> <strong>שיפור</strong> הנראות בייצור עם Zabbix, ELK, Grafana, AppDynamics</li>
